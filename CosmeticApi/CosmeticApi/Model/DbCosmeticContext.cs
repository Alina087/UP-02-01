...
public partial class DbCosmeticContext : DbContext
{
    public DbCosmeticContext()
    {
    }

    public DbCosmeticContext(DbContextOptions<DbCosmeticContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;user=root;password=1234;database=db_cosmetic", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.44-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cart>(entity =>
        {
            ...
            entity.Property(e => e.CartTovarCount).HasColumnName("cart_tovar_count");

            entity.HasOne(d => d.TovarArticleNavigation).WithMany(p => p.Carts)
                .HasForeignKey(d => d.TovarArticle)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_tovars");
